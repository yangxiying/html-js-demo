    ...
    if (!e.WebVideoCtrl) {
        var t = function () {
            ...
            var _ = function () {
                ...
                console.log("a.bNoPlugin=="+a.bNoPlugin);
                console.log(a)
                if (a.bNoPlugin) {
                    var e = f.browser();
            ...
            this.I_Login = function (t, r, s, o, i, a) {
                ...
                if (f.extend(P, t), -1 != r) {
                    ...
                    var e = f.browser();
                    var issssss= !!(e.chrome && parseInt(e.version, 10) > 45 || e.mozilla && parseInt(e.version, 10) > 52)
                    if(issssss){
                        (_("RTSP RealPlay"), s = h.oProtocolInc.CGI.startRealPlay, o = "rtsp://", c = P.iStreamType, a = P.iChannelID, B(P.iRtspPort) || (h.iRtspPort = P.iRtspPort), -1 == h.iRtspPort && (h.iRtspPort = J(h).iRtspPort), i = h.iRtspPort)
                ...
                if (re()) e = 0; else if (t.msie) try {
                    ...
                    console.log('new ActiveXObject("WebVideoKitActiveX.WebVideoKitActiveXCtrl.1") err');
                    console.log(n);
